...
Hooks.once('init', function () {
  ...
  CONFIG.Actor.dataModels = {
    character: models.UnboundFateCharacter,
    npc: models.UnboundFateNPC
  }
  CONFIG.Item.documentClass = UnboundFateItem;
  CONFIG.Item.dataModels = {
    item: models.UnboundFateItem,
    feature: models.UnboundFateFeature,
    spell: models.UnboundFateSpell
  }
